...
const char ATcmdNameAnswer[] =  {"OK+NAME:DoraCopter"};	//{BT_BAUD_AT};//
const char ATcmdNameSet[] = 	 {"AT+NAMEDoraCopter"};    //设置蓝牙设备名为：Crazepony，当然可以在这里修改成 what ever you want...
...
{	
	...
	if(CmdJudgement(ATcmdAnswer) == true)
	{
		...
		if(CmdJudgement(ATcmdNameAnswer)!=true)
		{
