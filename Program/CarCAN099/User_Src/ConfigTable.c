...
void ParamSetDefault(void) 
{
     ...
     pitch_angle_PID.P = 3.50;//3.7;
     pitch_angle_PID.I = 0;//1.0;		//0
     pitch_angle_PID.D = 0;
		 
	   pitch_angle_PID.iLimit = 300;	//or 1000
		 
     pitch_rate_PID.P  = 0.90 * coef; //0.8; 
     pitch_rate_PID.I  = 0.5 * coef; 		//0.5
     pitch_rate_PID.D  = 0.04 * coef; 		 
	
		 pitch_rate_PID.iLimit = 300;
///////////////////////////////////////////
     roll_angle_PID.P = 3.50;//
     roll_angle_PID.I = 0;//1.0;
     roll_angle_PID.D = 0;
		 roll_angle_PID.iLimit = 300;	//or 1000

     roll_rate_PID.P  = 0.9 * coef;//
     roll_rate_PID.I  = 0.5 * coef; 	//0.5
     roll_rate_PID.D  = 0.04* coef; 
...
//
			...
			alt_vel_PID.P=0.11f;	//0.1
			alt_vel_PID.I=0.02f;
			alt_vel_PID.D=0;
			
			 //should change to read eeprom cfg. should be 0.
