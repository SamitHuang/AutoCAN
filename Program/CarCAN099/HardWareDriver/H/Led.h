...
#define LedA_on    GPIO_SetBits(GPIOA, GPIO_Pin_0)
#define LedA_off   GPIO_ResetBits(GPIOA, GPIO_Pin_0)
...
#define LEDA_troggle GPIO_WriteBit(GPIOA,GPIO_Pin_0, !GPIO_ReadOutputDataBit(GPIOA,GPIO_Pin_0))
#define LEDB_troggle // GPIO_WriteBit(GPIOA,GPIO_Pin_8, !GPIO_ReadOutputDataBit(GPIOA,GPIO_Pin_8))
#define LEDC_troggle GPIO_WriteBit(GPIOB,GPIO_Pin_4, !GPIO_ReadOutputDataBit(GPIOB,GPIO_Pin_4))
#define LEDD_troggle GPIO_WriteBit(GPIOB,GPIO_Pin_3, !GPIO_ReadOutputDataBit(GPIOB,GPIO_Pin_3))
